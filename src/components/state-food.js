...
import MuiBorok from "../Assets/Food/Mui-Borok.jpeg";
import Bhangui from "../Assets/Food/Bhangui.jpeg";
...
const stateFoods = [
    ...
    },
    {
        ...
        foods: [
            ...
            {
                name: "Wahan Mung",
                description: "Wahan Mung is a type of Tripuri dish made with mung beans and spices, often served as a snack or light meal. The mung beans are boiled and mixed with a variety of local spices, including ginger, garlic, and turmeric. It's a vegetarian dish that is both healthy and filling. Wahan Mung is often paired with steamed rice or eaten on its own with side dishes. It's common in both rural and urban Tripura and reflects the simple yet flavorful cuisine of the region. The dish is known for its rich taste and nutritional benefits. It’s particularly popular during festivals and community events.", image: wahanMung
            },
            {
                name: "Mashed Potato with Bamboo Shoot",
                description: "Mashed Potato with Bamboo Shoot is a unique and delicious dish from Tripura, combining the earthy flavors of bamboo shoot and mashed potatoes. The bamboo shoots are tenderized and then sautéed with a blend of spices and mustard oil. The dish is a common part of the indigenous cuisine and is often served as a side dish. It’s known for its light, fresh taste and is perfect for pairing with rice or other meats. The combination of potatoes and bamboo shoot gives it a rich, hearty flavor. It's also a nutritious option for those who love vegetables. This dish captures the essence of Tripuri culinary simplicity and freshness.", image: MashedPotato
            },
            {
                name: "Fish Curry (Ilish Bhaja)",
                description: "Ilish Bhaja is a traditional fish curry from Tripura, often made with the hilsa fish, a popular fish in the region. The fish is deep-fried before being simmered in a gravy made of mustard, turmeric, and other spices. The curry has a rich, aromatic flavor and is usually served with steamed rice. The combination of fish and spices makes it a favorite among both locals and visitors. This dish is particularly popular during festivals and special occasions in Tripura. Ilish Bhaja is a great way to experience the authentic flavors of Tripura’s coastal cuisine. The fish’s delicate texture and the bold, spicy gravy create a memorable meal.", image: FishCurry
            }
        ]
    ...
    },
    {
        ...
        foods: [
            {
                name: "Chole Bhature",
                description: "Chole Bhature is a quintessential Delhi dish made with spicy chickpeas(chole) served alongside deep- fried fluffy bread(bhature).The chole is cooked with a blend of aromatic spices, giving it a rich and tangy flavor.Bhature, made from fermented dough, is light yet indulgent.It’s a favorite breakfast or lunch dish for locals.Often served with a side of pickles, onions, and green chutney.This dish is a must-try for its hearty and comforting appeal.Found in almost every nook and corner of Delhi.", image:
            },
            {
                name: "Butter Chicken",
                description: "Butter Chicken is a creamy and flavorful dish that originated in Delhi.It features tender chicken cooked in a tomato - based gravy enriched with butter and cream.The smoky flavor comes from grilling the chicken before adding it to the gravy.This iconic dish pairs perfectly with naan, roti, or steamed rice.The rich and velvety texture of the curry makes it a hit among all age groups.Butter Chicken is a representation of Delhi’s love for indulgent and royal flavors.", image:
            },
            {
                name: "Paranthas",
                description: "Paranthas are a versatile and beloved food in Delhi, often enjoyed for breakfast or lunch.They are flatbreads stuffed with a variety of fillings like potatoes, paneer, radish, or mixed vegetables.Cooked with generous amounts of ghee, they have a crisp exterior and soft, flavorful interior.Paranthas are typically served with curd, pickles, and a dollop of butter.The Paranthe Wali Gali in Old Delhi is famous for its wide range of stuffed paranthas.This dish showcases the soul of Delhi’s street food culture.", image:
            },
            {
                name: "Aloo Tikki",
                description: "Aloo Tikki is a popular street food made from spiced mashed potatoes shaped into patties and shallow fried until golden brown.Served with tangy tamarind chutney, spicy mint chutney, and yogurt, it delivers a burst of flavors.It’s often topped with onions, pomegranate seeds, and chaat masala.The crispy exterior and soft interior make it a crowd favorite.This snack is synonymous with the bustling markets of Delhi.Aloo Tikki is a delightful treat that showcases the capital's vibrant street food scene.", image:
            },
            {
                name: "Kulfi Falooda",
                description: "Kulfi Falooda is a traditional dessert that is a perfect indulgence on hot Delhi days.It consists of rich and creamy kulfi(Indian ice cream) served with falooda(vermicelli) and rose syrup.Often garnished with nuts like almonds and pistachios, it offers a delightful combination of textures and flavors.The dish is a blend of cold, sweet, and floral notes that refresh the palate.Found in many sweet shops and street vendors across Delhi.Kulfi Falooda is a timeless favorite among locals and tourists alike.", image:
            }
