const langInfo = [
    ...
    most_spoken_languages: [
        {
            "language": "Malayalam",
            "percentage": "95-97%",
            "population": "approx. 65,000-68,000 people"
        },
        {
            "language": "Jeseri (Dweep Bhasha)",
            "percentage": "2-3%",
            "population": "approx. 1,500-2,000 people"
        },
        {
            "language": "Mahls",
            "percentage": "1-2%",
            "population": "approx. 800-1,200 people"
        }
    ]
 ...
 {
    id: "IN-MN",
    lang_info:"In Manipur, the most widely spoken language is Meitei (also called Manipuri), spoken by approximately 60-70% of the population, which translates to about 2.5 to 3 million people. Meitei is the official language of the state and is used in administration, education, and media. Nagamese and Hindi are also spoken by a significant portion of the population, with Nagamese spoken by about 10-15% of the population (around 0.4 to 0.6 million people), mainly among communities of Nagaland origin. Bengali is spoken by around 5-7% of the population, particularly among migrant communities and in the valley regions, equating to about 0.2 to 0.3 million people. The state is also home to various indigenous tribal languages such as Thadou, Kuki, and Tangkhul.",
    most_spoken_languages: [
            {
 ...
 {
    id: "IN-ML",
    lang_info:" he principal languages in Meghalaya are Khasi and Garo with English as the official language of the State. It was at the initiative of the Christian missionaries that the Khasi and Garo languages and literature have developed and emerged in the list of Modern India Languages. ",
    most_spoken_languages: [
      {
          "language": "Khasi",
          "percentage": "30-40%",
 ...
 {
    id: "IN-CT",
   lang_info:"Chhattisgarhi (छत्तीसगढ़ी) is an Indo-Aryan language spoken by approximately 16.25 million people from Chhattisgarh, Odisha, Madhya Pradesh and Maharashtra in India.In Chhattisgarh, the most widely spoken language is Chhattisgarhi, which is spoken by approximately 70-75% of the population, equating to around 17-18 million people. Chhattisgarhi is the primary language of daily communication, culture, and folk traditions in the stateIt is the official language of Chhattisgarh. It is grouped within the Eastern Hindi languages and is counted by the Indian national census as a dialect of Hindi.",
   most_spoken_languages: [
            {
 ...
 {
    id: 'IN-OR',
    lang_info:"Odisha, state of India. Located in the northeastern part of the country, In Odisha, the most widely spoken language is Odia, spoken by approximately 80-85% of the population, which translates to around 35-37 million people. Odia is the official language of the state and is used in administration, education, and media. Hindi is the second most spoken language, particularly in urban areas and among migrant populations, accounting for about 10-12% of the population, or roughly 4.3 to 5.2 million people. ",
    most_spoken_languages: [
      {
         "language": "Odia",
         "percentage": "80-85%",
 ...
 {  id: 'IN-JH',
   lang_info:"Jharkhand, state of India, located in the northeastern part of the country.In Jharkhand, the most widely spoken language is Hindi, which is spoken by approximately 50-55% of the population, equating to around 14-16 million people. Sadri, a regional language spoken primarily in the Chotanagpur plateau, is also widely used, spoken by about 20-25% of the population, or roughly 5.5 to 7 million people. Santali, a major tribal language, is spoken by around 15-20% of the population, translating to about 4.1 to 5.5 million people, particularly in the eastern and southern regions of the state. ",
   most_spoken_languages: [
      {
          "language": "Hindi",
          "percentage": "50-60%",
