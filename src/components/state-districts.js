...
const stateDistrict = [
 ...
 {
   id: 'IN-UP',
   dist_info:"Uttar Pradesh, India’s most populous state, is divided into 75 districts. Lucknow, the capital, is known for its nawabi culture, Imambaras, and chikankari embroidery. Varanasi, the spiritual capital of India, is revered for its ghats and Kashi Vishwanath Temple. Agra features the iconic Taj Mahal, a UNESCO World Heritage Site. Prayagraj hosts the Kumbh Mela, the largest religious gathering in the world. Mathura and Vrindavan are significant for their Krishna temples. UP’s diverse economy is driven by agriculture, handicrafts, and tourism."
 },
 {
    id: 'IN-GJ',
 ...
 {id: 'IN-UT',
  lang_info:"Telugu, the official language of Andhra Pradesh and Telangana, is one of India’s classical languages, renowned for its lyrical and poetic nature. It has a rich literary heritage, with works like Nannayya’s Mahabharatam. Telugu films (Tollywood) are a significant part of Indian cinema. Traditional dances like Kuchipudi and folk arts like Burrakatha are integral to Telugu culture."
 },
