...
const stateDistrict = [
  ...
  },
  {
    id: "IN-AR",
    dist_info:
      "As of February 2024, the Indian state Arunachal Pradesh comprised 27 districts, not including Itanagar capital complex, with more districts proposed. Most of the districts are inhabited by various indigenous tribes. The districts are further divided into sub-divisions, circles, and villages. The districts, with their headquarters, are listed below:",
    Capital: ["Itanagar"],
    Total_Districts: [25],
    districts: [
      "1. Anjaw",
...

  {
    id: "IN-MN",
    dist_info:
      "Manipur, known as the Jewel of India is divided into 16 districts, each with distinct cultural and natural attractions. Imphal, the capital, is home to the Kangla Fort and the bustling Ima Keithel (women's market). Bishnupur is famous for its ancient temples and Loktak Lake, the largest freshwater lake in northeast India. Churachandpur showcases tribal diversity and natural beauty. Ukhrul, the land of the Shirui Lily, offers stunning landscapes, while Tamenglong is known for its orange orchards and waterfalls. Senapati and Kangpokpi feature lush forests and hills, while Thoubal and Kakching boast vibrant cultural traditions and agricultural richness.",
    Capital: ["Imphal"],
    Total_Districts: [16],
    districts: [
      "1. Bishnupur",
...

  {
    id: "IN-AP",
    dist_info:
      "Arunachal Pradesh is made up of 26 districts. Every district of the state is governed by a district collector who also looks after the requirements of the regional population. Given below are the names of the 16 districts of Arunachal Pradesh along with their headquarters:",
    Capital: ["Amaravati"],
    Total_Districts: [26],
    Districts: [
      "1. Anantapur",
...

  {
    id: "IN-GA",
    dist_info:
      "Goa, India's smallest state by area, is famous for its beaches, vibrant nightlife, and Portuguese heritage. Divided into North Goa and South Goa districts, it offers a unique blend of nature and culture. North Goa is bustling with popular beaches like Baga, Calangute, and Anjuna, along with historic forts such as Aguada and Chapora. South Goa is quieter, featuring serene beaches like Palolem and Colva and luxurious resorts. Panaji, the state capital, is known for the Latin Quarter of Fontainhas and the Church of Our Lady of the Immaculate Conception. Old Goa is home to UNESCO World Heritage sites like the Basilica of Bom Jesus. Goa’s festivals like Carnival and Shigmo showcase its vibrant cultural traditions",
    Capital: ["Panaji"],
    Total_Districts: [2],
    Districts: ["1. North Goa", "2. South Goa"],
  },

  {
    id: "IN-CT",
    dist_info:
      "Chhattisgarh, known as the Rice Bowl of India, is a state rich in minerals, forests, and tribal culture, divided into 33 districts. Raipur, the capital, is a fast-developing city with landmarks like Swami Vivekananda Sarovar. Bastar is famed for its tribal heritage, Danteshwari Temple, and Chitrakote Falls, often called the Niagara of India. Bilaspur is a commercial hub with the Kanan Pendari Zoological Park. Jagdalpur showcases stunning waterfalls like Tirathgarh and the Kanger Valley National Park. Chhattisgarh is also known for its traditional handicrafts, bell-metal art, and festivals like Bastar Dussehra, celebrated with tribal customs.",
    Capital: ["Raipur"],
    Total_Districts: [33],
    Districts: [
      "1. Balod",
  ...
  },
  {
    id: "IN-OR",
    dist_info:
      "Odisha, the Soul of Incredible India, has 30 districts rich in heritage and natural beauty. Bhubaneswar, the state capital, is the Temple City of India with landmarks like Lingaraj Temple and Mukteshwar Temple. Puri, part of the Char Dham pilgrimage, is famous for the Jagannath Temple and Rath Yatra. Konark hosts the iconic Sun Temple, a UNESCO World Heritage Site. Cuttack is known for silver filigree craftsmanship and the Barabati Fort. Sambalpur features the Hirakud Dam, India’s longest, and tribal culture. Chilika Lake, Asia’s largest brackish water lagoon, attracts migratory birds. Odisha is also known for classical Odissi dance and sand art by Sudarsan Pattnaik.",
...

  {
    id: "IN-MP",
    dist_info:
      "Madhya Pradesh, the Heart of India has 52 districts rich in history, wildlife, and architecture. Bhopal, the capital, is known for its lakes and the Bhimbetka rock shelters (UNESCO-listed). Indore, a commercial hub, is famous for street food. Khajuraho’s temples, adorned with intricate sculptures, and Sanchi’s ancient Buddhist stupas are UNESCO World Heritage Sites. The state has numerous national parks, including Kanha and Bandhavgarh, known for tigers. Madhya Pradesh is also famous for its tribal art, including Gond painting and Baiga jewelry.",
    Capital: ["Bhopal"],
    Total_Districts: [52],
    Districts: [
      "1. Agar Malwa",
...

  {
    id: "IN-DD",
    lang_info:
      "Gujarat, in western India, is known for its entrepreneurial spirit, historical sites, and vibrant festivals. Ahmedabad, the largest city, houses the Sabarmati Ashram and historic pols. Gandhinagar, the capital, features the Akshardham Temple. The Gir National Park is the only home of the Asiatic lions. Kutch is famous for the Rann Utsav, a desert festival showcasing local culture and handicrafts. Somnath and Dwarka are significant pilgrimage sites. Gujarat is also renowned for its textile industry and cuisine, including dhokla, thepla, and fafda.",
    Capital: ["Daman"],
    Total_Districts: [2],
    Districts: ["1. Daman", "2. Diu"],
  },
  {
    id: "IN-RJ",
    lang_info:
      "Rajasthan, the Land of Kings offers a regal experience with its 33 districts. Jaipur, the capital, is part of the Golden Triangle and features UNESCO sites like Amer Fort and Jantar Mantar. Udaipur, the City of Lakes, and Jodhpur, the Blue City,showcase palaces and forts. Jaisalmer is famed for its golden dunes and Sonar Quila. Pushkar hosts the world-famous camel fair. Ranthambore and Sariska are renowned for wildlife. The state is celebrated for its folk music, handicrafts, and colorful festivals like Gangaur and Teej.",
    Capital: ["Jaipur"],
    Total_Districts: [33],
    Districts: [
      "1. Ajmer",
  ...
  },
  {
    id: "IN-HR",
    lang_info:
      "Haryanvi (हरियाणवी or हरयाणवी), also called Bangru and Jatu, is an Indo-Aryan language spoken primarily in the Indian state of Haryana and the territory of Delhi.[4] Haryanvi is considered to be part of the dialect group of Western Hindi, which also includes Khariboli and Braj. It is written in the Devanagari script.The Rangri dialect of Haryanvi of the Ranghar community is still spoken by Muhajir emigres in the Pakistani provinces of Punjab and Sindh though has become within Haryana itself. The dialect is written in the Nastaliq variant of the Arabic script.",
