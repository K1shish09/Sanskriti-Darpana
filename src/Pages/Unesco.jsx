...
const heritageSites = [
  ...
  { name: 'Buddhist Monuments at Sanchi', location: 'Madhya Pradesh', image: 'https://upload.wikimedia.org/wikipedia/commons/thumb/4/4e/Mahabodhitemple.jpg/150px-Mahabodhitemple.jpg', description: 'Famous Buddhist stupas and monuments dating back to  the 3rd century BC.' },
  ...
  { name: 'Dholavira', location: 'Gujarat', image: 'https://th.bing.com/th?id=OSK.HEROciCQq_JYIJss4rm8bzK_rdQK95JdpqKnuG0SLYIAZ6Y&w=312&h=200&c=15&rs=2&o=6&pid=SANGAM', description: 'An ancient Harappan city was  known for its water management system.' },
  ...
  { name: 'Kachchh', location: 'Gujarat', image: 'https://www.bing.com/th?id=OIP.8WVF9-s4zzFxhaeU99L8OwHaEC&w=181&h=185&c=8&rs=1&qlt=90&o=6&pid=3.1&rm=2', description: 'Known for its white salt desert and  the cultural heritage.' },
